...
//      //  save(employee);
    ...
    public static Car getCarByCode(int code) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                car.setAvailable(rs.getString(7));
        ...
        log.info("get data car by code - end: car = {}", car);
        return car;
    }
    ...
    public static Car showCarIsNotDeleted() {
        ...
        log.info("get data car  code - end: car = {}", car);
        return car;
    }
    ...
    public static List<Car> getAllCars() {
        log.info("get all data cars - strt");
        List<Car> listCars = new ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
              ...
              //  if (car.getAvailable().equals("available")){
                    listCars.add(car);
               // }
            }
            connection.close();
    ...
    public static List<Car> getAvailableCar() {
        log.info("get all available data car- strt");
        List<Car> listCars = new ArrayList<>();
        ...
        log.info("get all available cars - end");
        return listCars;
    }
}